...
export const CreatePatient = (
  data: req.PatientCreate,
): Promise<res.PatientCreateResponse> => {
...
export const GetPatientList = (
  data: req.PatientListQuery,
): Promise<res.PatientListResponse> => {
...
export const GetPatientDetail = (
  data: req.GetDetailRequest,
): Promise<res.PatientDetailResponse> => {
...
export const UpdatePatient = (
  data: req.UpdatePatientRequest,
): Promise<res.PatientUpdateResponse> => {
...
export const DeletePatient = (
  data: req.GetDetailRequest,
): Promise<res.PatientDeleteResponse> => {
