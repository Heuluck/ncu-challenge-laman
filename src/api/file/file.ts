 ...
 * 管理员或超级管理员权限
 */
export const UploadFile = (data: req.FileUpload): Promise<res.FileUploadResponse> => {
 ...
 * 获取文件列表
 */
export const GetFileList = (data: req.FileListQuery): Promise<res.FileListResponse> => {
 ...
 * 管理员或超级管理员权限
 */
export const DeleteFile = (data: req.DeleteFileRequest): Promise<res.FileDeleteResponse> => {
 ...
 * 超级管理员权限
 */
export const AuthorizeDownload = (data: req.AuthorizeDownloadRequest): Promise<res.AuthorizeDownloadResponse> => {
